            ...
            <table class="table align-items-center table-flush">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-success" href="{{ route('desc.kategori', $row->id) }}" title="ubah status pembayaran"><i
                          class="fa-solid fa-eye"></i></a>
                        <a class="btn btn-danger" data-toggle="modal" data-target="#delete{{ $row->id }}"><i
