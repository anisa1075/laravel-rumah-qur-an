        ...
        <div class="row">
            <div class="col-12">
                <div class="card" style="padding: 1rem; margin-top:1rem;">
                    ...
                    <form action="{{ route('update.testimoni', $testimoni->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" id="user_id" name="user_id">
                                <option selected>{{ $testimoni->santri->nama }}</option>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" id="kategori_id" name="kategori_id">
                                <option selected>{{ $testimoni->kategori->nama_kategori }}</option>
