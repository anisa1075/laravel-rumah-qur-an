        ...
        <div class="row">
            <div class="col-12">
                <div class="card" style="padding: 1rem; margin-top:1rem;">
                    ...
                    <form action="{{ route('update.guru', $dataGuru->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" id="guru_id"
                                name="guru_id">
                                <option >{{ $dataGuru->guru->nama }}</option>
                                @foreach ($guru as $row)
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" id="kategori_id"
                                name="kategori_id">
                                <option selected>{{ $dataGuru->kategori->nama_kategori }}</option>
