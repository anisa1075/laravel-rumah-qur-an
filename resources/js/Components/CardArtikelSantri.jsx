                            ...
                            <div class="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-lg">
                                ...
                                <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                                    ...
                                    <p class="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                                        ...
                                        Tentang artikel "{artikel.judul}" disini

                                    </p>
                                    <a> <Link href={`/desc/artikel/santri${artikel.id}`} component={ShowArtikel} class="rounded-full hover:bg-white hover:text-black bg-neutral-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60">
                                        See More</Link>
                                    </a>
                                </div>
                            </div>
...
export default CardArtikelSantri;