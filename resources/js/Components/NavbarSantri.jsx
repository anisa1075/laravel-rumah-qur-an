    ...
    return (
        ...
        >
            <div className="flex  justify-between items-center text-base gap-8">
                ...
                <ul className="md:flex py-8 space-x-12 hidden font-Poppins mr-20 outline-none focus:outline-none">
                    <li className="a block text-base hover:text-pink-500 ">
                        <Link href="/home/santri">Home</Link>
                    </li>
                                ...
                                <div className="a bg-white p-4 w-52 shadow-lg absolute top-10">
                                    ...
                                    {data.map((kategori) => (
                                        <li className="a mb-4">
                                            ...
                                            <a href={`/detail/program/santri/${kategori.id}`} onClick={() => setOpen(false)} className="p-2  text-md-start cursor-pointer rounded hover:text-pink-500 hover:bg-pink-50">{kategori.nama_kategori}</a>
                                        </li>
                                        ))}
                                    </ul>
                                </div>
                    ...
                    <li className="a block text-base hover:text-pink-500">
                        <a>
                            <Link href="/guru/santri">Guru</Link>
                        </a>
                    </li>
                    <li className="a block text-base hover:text-pink-500">
                        <a>
                            <Link href="/santri/santri">Santri</Link>
                        </a>
                    </li>
                    <li className="a block text-base hover:text-pink-500">
                        <a>
                            <Link href="/artikel/santri">Artikel</Link>
                        </a>
                    </li>
                    <li className="a block text-base hover:text-pink-500">
                        <a>
                            <Link href="/testimoni/santri">Testimoni</Link>
                        </a>
                    </li>
                </ul>
                ...
                <div className="space-x-12 hidden lg:flex items-center">
                    ...
                    <a href="/santri/home" className="text-default text-black border-pink-50 bg-pink-200 border border-
default py-2 px-5 transition-all duration-300 hover:bg-pink-400 hover:text-white rounded-lg">
                         Dashboard
                    </a><br />
            ...
            {/* nav item for mobile */}
            <div
                className={`a space-y-6 pl-14 px-6 mt-20 py-9 bg-pink-100 ${isMenuOpen
                    ? "block fixed top-0 right-0 left-0"
                    : "hidden"
                    }`}
            >
                <li className="a block text-base hover:text-pink-500 ">
                    <a><Link href="/santri/home" className="a hover:text-white">
                        Home
                    </Link></a>
                </li>
                            ...
                            <div className="a bg-white p-4 w-52 shadow-lg absolute top-10">
                                <ul>
                                    <li>
                                        ...
                                        <a href="#" onClick={() => setOpen(false)} className="p-2  text-md-start cursor-pointer rounded hover:text-pink-500 hover:bg-pink-50">Tahsin</a>
                                    </li>
                                </ul>
                            </div>
