            ...
            >
                <div className="flex  justify-between items-center text-base gap-8">
                                    ...
                                    <div className="a bg-white p-4 w-52 shadow-lg absolute top-10">
                                        <ul>
                                            <li>
                                                ...
                                                <a href="/detail/program" onClick={() => setOpen(false)} className="p-2  text-md-start cursor-pointer rounded hover:text-pink-500 hover:bg-pink-50">Tahsin</a>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div className="space-x-12 hidden lg:flex items-center">
                        ...
                        <a href="/guru/home" className="text-default text-black border-pink-50 bg-pink-200 border border-
