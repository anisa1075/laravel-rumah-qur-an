    ...
    return (
        <div className='a md:px-14 px-4 py-5 max-w-screen-2xl mx-auto bg-white'>
            ...
            <div
                ...
                {kategori && (
                    <form onSubmit={handleSubmit} className='a w-full '>
                        ...
                        <a href='https://wa.me/6285267794627?text=Assalamualaikum%20Admin' className='a mt-5 px-10' type='submit' gradientMonochrome="pink">Wa</a>
